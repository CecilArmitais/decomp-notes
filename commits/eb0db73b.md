# `eb0db73b` — Decomp ApplyDamage; fix a message-id parameter type and three field types

| | |
|---|---|
| **Commit** | `eb0db73b` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of `c1a61413` |
...
- **Only the US branch is decompiled by this commit.** The original asm block
  ...
  duplications. **Superseded**: [`e0f71917`](e0f71917.md) matches EU and JP as
