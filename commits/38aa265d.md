# `38aa265d` — Decomp CalcTypeBasedDamageEffects; pad damage_calc_diag to its real layout

| | |
|---|---|
| **Commit** | `38aa265d` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of `5f96316f` |
...
Continues the damage cluster from [`eb0db73b`](eb0db73b.md) /
[`e0f71917`](e0f71917.md) (`ApplyDamage`) and [`5f96316f`](5f96316f.md)
