# `1dc24515` — Decompile 13 more callees; all merge at a file boundary

| | |
|---|---|
| **Commit** | `1dc24515` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of [`b8fb6d24`](b8fb6d24.md) |
...
The second batch of the same shape as [`b8fb6d24`](b8fb6d24.md): small callees of
...
- **Only the US ROM was built.** Unlike [`bd3c6e4a`](bd3c6e4a.md), which records
...
[`bd3c6e4a`](bd3c6e4a.md) corrected this function's declaration from
...
`include/main_020114F8.h` in [`b8fb6d24`](b8fb6d24.md).
...
- **`include/main_0200F798.h` now declares `RemoveItemNoHoleCheck` twice**, lines 6
  ...
  [`bd3c6e4a`](bd3c6e4a.md) had already corrected.
