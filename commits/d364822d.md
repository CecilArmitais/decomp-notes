# `d364822d` — Decomp CalcTypeBasedDamageEffects; pad damage_calc_diag to its real layout

| | |
|---|---|
| **Commit** | `d364822d` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of `cd5c7d56` |
...
Continues the damage cluster from [`a51777ff`](a51777ff.md) /
[`ce359434`](ce359434.md) (`ApplyDamage`) and [`cd5c7d56`](cd5c7d56.md)
