# `f47593d9` — Decomp `sub_0203D538`; replace its stale extern with the new header

| | |
|---|---|
| **Commit** | `f47593d9` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of [`d814f8d0`](d814f8d0.md) |
