# `a51777ff` — Decomp ApplyDamage; fix a message-id parameter type and three field types

| | |
|---|---|
| **Commit** | `a51777ff` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of `afd96d2b` |
...
- **Only the US branch is decompiled by this commit.** The original asm block
  ...
  duplications. **Superseded**: [`ce359434`](ce359434.md) matches EU and JP as
