# `cad4a75f` — Decompile 38 more callees; clear five more asm files entirely

| | |
|---|---|
| **Commit** | `cad4a75f` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of [`8da3a5dd`](8da3a5dd.md) |
