# `449eba01` — Decompile `GenerateMission` (`0x0205D224`)

| | |
|---|---|
| **Commit** | `449eba01` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of [`bd3c6e4a`](bd3c6e4a.md) |
...
Counted here from `449eba01^:asm/main_0205D1F4.s`, not taken from the wip:
...
**Already retired, partly.** A later branch commit (`1dc24515`) decompiled
