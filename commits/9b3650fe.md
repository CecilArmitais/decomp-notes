# `9b3650fe` — Decompile 26 more callees; clear six asm files entirely

| | |
|---|---|
| **Commit** | `9b3650fe` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of [`49da4ee9`](49da4ee9.md) |
...
the one structural difference from [`240bea14`](240bea14.md), which split a
...
[`240bea14`](240bea14.md), where `ChangeMonsterAnimationToIdle`'s `enum` spelling
cost two rows).

### What this does to `DrawTextInWindow`'s open question

[`240bea14`](240bea14.md) left as an open question that `DrawTextInWindow` was
