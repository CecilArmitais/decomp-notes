# `5271b77a` — Decomp ApplyDamage; fix a message-id parameter type and three field types

| | |
|---|---|
| **Commit** | `5271b77a` (as of writing — renamed if amended or rebased) |
| **Branch** | `decomp-continued`, on top of `058707bc` |
...
- **Only the US branch is decompiled by this commit.** The original asm block
  ...
  duplications. **Superseded**: [`ef68e88d`](ef68e88d.md) matches EU and JP as
